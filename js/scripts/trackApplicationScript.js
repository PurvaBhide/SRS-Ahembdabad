...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showApplicationDetails(data, message) {
        ...
        console.log('📊 Response Type:', isFundAnIdea ? 'FundAnIdea' : 'Participant');
        ...
        modalBody.innerHTML = `
            ...
            <div class="info-grid">
                <div class="info-item highlight-item">
                    ...
                    <div class="info-value">${isFundAnIdea 
                ...
                <div class="info-item highlight-item">
                    <div class="info-label">${isFundAnIdea ? 'Project Name' : 'Participant Name'}</div>
                    <div class="info-value">${isFundAnIdea 
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">${actualData.projetcId || 'N/A'}</div>
                </div>
                ...
                <div class="info-item">
                    <div class="info-label">Organization Name</div>
                    <div class="info-value">${actualData.organizationName || 'N/A'}</div>
                </div>

                <div class="info-item contact-item">
                    <div class="info-label">Email ID</div>
                    <div class="info-value">${actualData.participantEmail || 'N/A'}</div>
                </div>

                <div class="info-item contact-item">
                    <div class="info-label">Mobile Number</div>
                    <div class="info-value">${actualData.participantMobileNumber || 'N/A'}</div>
                </div>

                <div class="info-item amount-item">
                    <div class="info-label">Amount</div>
                    <div class="info-value">₹${formatAmount(actualData.amount)}</div>
                </div>

                ${actualData.note ? `
                <div class="info-item full-width">
                    <div class="info-label">Notes</div>
                    <div class="info-value">${actualData.note || 'No notes available'}</div>
                </div>
                ` : ''}
                ` : ''}
            </div>
...
function openDocument(documentUrl, token) {
    try {
        ...
        if (newTab) {
            ...
            showDocumentMessage('Failed to open document. Please check popup blocker.', 'error');
        }

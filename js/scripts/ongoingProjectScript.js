...
//     const API_BASE_URL = 'https://mumbailocal.org:8087';
...
//     // Load projects by category with pagination support using direct API call
//     function loadProjectsByCategory(categoryId) {
//         console.log(`Loading projects by category ${categoryId} - Page: ${currentPage}, Size: ${pageSize}`);
        
//         // Make direct API call with pagination parameters
//         const url = `${API_BASE_URL}/projectshowbycategoryid/${categoryId}?page=${currentPage}&size=${pageSize}`;
...
//     // Load projects by both category and budget using direct API call
//     function loadProjectsByCategoryAndBudget(categoryId, budget) {
//         console.log('Loading projects with both filters - Category:', categoryId, 'Budget:', budget);
        
//         // Use direct API call to get all category data, then filter by budget
//         const url = `${API_BASE_URL}/projectshowbycategoryid/${categoryId}?page=0&size=1000`; // Get more data to ensure we have all results
...
//             loadProjects();
//         } else if (category !== '0' && budget === 'all') {
//             // Only category selected - use server pagination
//             loadProjectsByCategory(category);
//         } else if (category === '0' && budget !== 'all') {
//             // Only budget selected - check if budget API supports pagination
//             loadProjectsByBudget(budget);
//         } else {
//             // Both category and budget selected - use client-side pagination
//             loadProjectsByCategoryAndBudget(category, budget);
...
//     // Load projects by category with pagination support
//     function loadProjectsByCategory(categoryId) {
//         console.log(`Loading projects by category ${categoryId} - Page: ${currentPage}, Size: ${pageSize}`);
        
//         // If your API accepts pagination parameters, use this format:
//         // ProjectService.projectbycategry(categoryId, currentPage, pageSize)
...
//     // Load projects by budget with pagination support
//     function loadProjectsByBudget(budget) {
//         console.log(`Loading projects by budget ${budget} - Page: ${currentPage}, Size: ${pageSize}`);
...
//             .then(function(response) {
//                 console.log('Budget API Response:', response);
//                 // Check if budget API also returns pagination info like category API
//                 handleProjectResponseWithServerPagination(response);
//             })
//             .catch(function(error) {
//                 console.error('Error loading projects by budget:', error);
...
//                     // For combined filters, use client-side pagination since we're filtering after API call
//                     handleClientSidePagination(filteredProjects);
//                 } else {
//                     displayNoProjects();
//                 }
...
//     // Handle API response with option for client-side pagination
//     function handleProjectResponse(response, forceClientSide = false) {
//         if (forceClientSide) {
//             // Handle client-side pagination for cases where API doesn't support it
//             let projectsArray = [];
//             if (response && response.status === 200 && response.data) {
//                 if (Array.isArray(response.data)) {
//                     projectsArray = response.data;
